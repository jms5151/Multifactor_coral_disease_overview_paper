...
validation_filepath <- 'data/validation_data/forec_validation_df.csv'
...
basePath_id <- 'data/validation_data/forec_ws_REGION_validation_df_withID.csv'
basePath_pred <- 'data/validation_data/forec_ws_REGION_validation_df_withID-v2output.csv'
...
# save
write.csv(v2_ws_pac, 'data/validation_data/v2_ws_pac.csv', row.names = F)
write.csv(v2_ws_gbr, 'data/validation_data/v2_ws_gbr.csv', row.names = F)
...
# save
write.csv(v3_ws_pac, 'data/validation_data/v3_ws_pac.csv', row.names = F)
...
# save
write.csv(v3_ws_gbr, 'data/validation_data/v3_ws_gbr.csv', row.names = F)
...
# save
write.csv(v3_ga_pac, 'data/validation_data/v3_ga_pac.csv', row.names = F)
...
# save
write.csv(v3_ga_gbr, 'data/validation_data/v3_ga_gbr.csv', row.names = F)
...
# write.csv(sst_wide, 'data/validation_data/sst_cfs_forecasts_validation.csv', row.names = F)
...
# save
write.csv(forec_forecasts_agg, 'data/validation_data/v3_forecasts_aggregated.csv')
